...
open class _UIHostingView<Content>: UIView, XcodeViewDebugDataProvider where Content: View {
    ...
    // Audited for 6.5.4
    override dynamic func _hitTest(with context: _UIHitTestContext?) -> (UIResponder & _UIGestureRecognizerContainer)? {
    ...
    // Audited for 6.5.4
    override dynamic var _childContainers: [any _UIGestureRecognizerContainer] {
