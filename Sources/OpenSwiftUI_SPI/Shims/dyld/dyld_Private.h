...
typedef OPENSWIFTUI_ENUM(uint32_t, DYLD_MACOSX_VERSION) {
    ...
    DYLD_MACOSX_VERSION_14_0 = 0x000E0000,
    DYLD_MACOSX_VERSION_15_0 = 0x000F0000,
    DYLD_MACOSX_VERSION_26_0 = 0x001A0000,
    DYLD_MACOSX_VERSION_26_1 = 0x001A0100,
    DYLD_MACOSX_VERSION_26_2 = 0x001A0200,
    DYLD_MACOSX_VERSION_26_3 = 0x001A0300,
    DYLD_MACOSX_VERSION_26_4 = 0x001A0400,
    DYLD_MACOSX_VERSION_26_5 = 0x001A0500,
};
...
typedef OPENSWIFTUI_ENUM(uint32_t, DYLD_IOS_VERSION) {
    ...
    DYLD_IOS_VERSION_13_0 = 0x000D0000,
    DYLD_IOS_VERSION_14_0 = 0x000E0000,
    DYLD_IOS_VERSION_15_0 = 0x000F0000,
    DYLD_IOS_VERSION_18_0 = 0x00120000,
    DYLD_IOS_VERSION_26_0 = 0x001A0000,
    DYLD_IOS_VERSION_26_1 = 0x001A0100,
    DYLD_IOS_VERSION_26_2 = 0x001A0200,
    DYLD_IOS_VERSION_26_3 = 0x001A0300,
    DYLD_IOS_VERSION_26_4 = 0x001A0400,
    DYLD_IOS_VERSION_26_5 = 0x001A0500,
};
