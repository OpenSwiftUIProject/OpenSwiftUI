...
extension [SwiftSetting] {
    ...
    fileprivate static func availabilityMacroSettings(ignoreAvailability: Bool) -> Self {
        ...
        return [
            ...
            .enableExperimentalFeature("AvailabilityMacro=OpenSwiftUI_v7_0:\(ignoreAvailability ? minimumVersion : "iOS 26.0, macOS 26.0, tvOS 26.0, watchOS 26.0, visionOS 26.0")"),
            .enableExperimentalFeature("AvailabilityMacro=OpenSwiftUI_v8_0:\(ignoreAvailability ? minimumVersion : "iOS 27.0, macOS 27.0, tvOS 27.0, watchOS 27.0, visionOS 27.0")"),
...
let openSwiftUISPITarget = Target.target(
    ...
    exclude: ["Resources/CoreDateProvider.strings"],
    publicHeadersPath: ".",
