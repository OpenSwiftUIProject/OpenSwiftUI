...
let hostingExampleSettings = commonAppSettings.merging([
    ...
    "INFOPLIST_KEY_UIApplicationSupportsIndirectInputEvents[sdk=xrsimulator*]": "YES",
    ...
    "INFOPLIST_KEY_UILaunchStoryboardName[sdk=xros*]": "LaunchScreen",
    "INFOPLIST_KEY_UILaunchStoryboardName[sdk=xrsimulator*]": "LaunchScreen",
    "INFOPLIST_KEY_UIMainStoryboardFile[sdk=iphoneos*]": "Main",
    "INFOPLIST_KEY_UIMainStoryboardFile[sdk=iphonesimulator*]": "Main",
    "INFOPLIST_KEY_UIMainStoryboardFile[sdk=xros*]": "Main",
    "INFOPLIST_KEY_UIMainStoryboardFile[sdk=xrsimulator*]": "Main",
    "LD_RUNPATH_SEARCH_PATHS": [
        "$(inherited)",
        "@executable_path/Frameworks",
    ],
