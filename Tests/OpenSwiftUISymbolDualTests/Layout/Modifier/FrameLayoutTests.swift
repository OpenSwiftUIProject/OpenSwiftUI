...
extension _FlexFrameLayout {
    @_silgen_name("OpenSwiftUITestStub_FlexFrameLayoutInit")
    init(
        swiftUI_minWidth: CGFloat? = nil,
        swiftUI_idealWidth: CGFloat? = nil,
        swiftUI_maxWidth: CGFloat? = nil,
        swiftUI_minHeight: CGFloat? = nil,
        swiftUI_idealHeight: CGFloat? = nil,
        swiftUI_maxHeight: CGFloat? = nil,
        swiftUI_alignment: Alignment
    )
}
...
struct FlexFrameLayoutTests {
    ...
    func initializationWithValidConstraints(
        ...
        let layout = _FlexFrameLayout(
            swiftUI_minWidth: minWidth,
            swiftUI_idealWidth: idealWidth,
            swiftUI_maxWidth: maxWidth,
            swiftUI_minHeight: minHeight,
            swiftUI_idealHeight: idealHeight,
            swiftUI_maxHeight: maxHeight,
            swiftUI_alignment: alignment
        )
    ...
    func initializationWithNilValues(alignment: Alignment) {
        let layout = _FlexFrameLayout(swiftUI_alignment: alignment)
